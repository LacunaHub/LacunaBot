...
import { validateAutomation } from '@/api/utility/validators/ValidateAutomation.js'
import database from '@/database/index.js'
import {
    type ServerDocument,
    type ServerModerationCaseLogType,
    type ServerModerationCaseLogTypeKey,
    type ServerModerationLogsTypeKey
} from '@/database/schemas/Servers.js'
import { lavalinkSources, supportServerId } from '@/internals/utility/Constants.js'
import { dotNotateObject } from '@/internals/utility/Utils.js'
import {
    borderRadiuses,
    textAligns,
    textDecorations,
    ...
    textStyles,
    textTransforms
} from '@/modules/ImageGenerator.js'
import { languages } from '@lacunahub/lacuna-locale'
import { type APIGuildMember, type APIUser, parseEmoji } from 'discord.js'
...
export async function setSettings(
    guild: ServerDocument,
    data: Partial<ServerDocument>,
    user_id: string
): Promise<ServerDocument> {
    const updateData: FilterQuery<ServerDocument> = {}
    ...
    if (data.moderation) {
        if (
            typeof data.moderation.respect_hierarchy === 'boolean' &&
            data.moderation.respect_hierarchy !== guild.moderation.respect_hierarchy
        ) {
        ...
        if (data.moderation.case_log) {
            if (
                (typeof data.moderation.case_log.channel_id === 'string' ||
                    data.moderation.case_log.channel_id === null) &&
            ...
            if (typeof data.moderation.case_log.types === 'object' && data.moderation.case_log.types !== null) {
                for (const type of Object.keys(data.moderation.case_log.types) as ServerModerationCaseLogTypeKey[]) {
                    const current = data.moderation.case_log.types[type]
                    const previous = guild.moderation.case_log.types[type]

                    if (JSON.stringify(current) !== JSON.stringify(previous)) {
                        const caseLogTypeData: Partial<ServerModerationCaseLogType> = {
                        ...
                        if (typeof previous.custom_dm_message !== 'undefined') {
                            caseLogTypeData['custom_dm_message'] =
                                current.custom_dm_message ?? previous.custom_dm_message
                        }
        ...
        if (data.moderation.logs) {
            if (typeof data.moderation.logs.types === 'object' && data.moderation.logs.types !== null) {
                const dataLogs = Object.keys(data.moderation.logs.types) as ServerModerationLogsTypeKey[]
                ...
                for (const log of dataLogs) {
                    ...
                    if (
                        ...
                        ((typeof current.channel_id === 'string' || typeof current.channel_id === null) &&
        ...
        if (data.moderation.warnings) {
            if (
                ...
                JSON.stringify(data.moderation.warnings.penalties) !==
                    JSON.stringify(guild.moderation.warnings.penalties)
            ) {
        ...
        if (data.moderation.automoder) {
            if (data.moderation.automoder.anti_caps) {
                ...
                if (
                    ...
                    data.moderation.automoder.anti_caps.percentage_of_caps !==
                        guild.moderation.automoder.anti_caps.percentage_of_caps
                ) {
                    if (
                        data.moderation.automoder.anti_caps.percentage_of_caps >= 1 &&
                        data.moderation.automoder.anti_caps.percentage_of_caps <= 100
                    ) {
                        updateData['moderation.automoder.anti_caps.percentage_of_caps'] =
                            data.moderation.automoder.anti_caps.percentage_of_caps
                    }
                }
                ...
                if (
                    ...
                    data.moderation.automoder.anti_caps.minimum_content_length !==
                        guild.moderation.automoder.anti_caps.minimum_content_length
                ) {
                    updateData['moderation.automoder.anti_caps.minimum_content_length'] =
                        data.moderation.automoder.anti_caps.minimum_content_length
                }

                if (
                    Array.isArray(data.moderation.automoder.anti_caps.options) &&
                    JSON.stringify(data.moderation.automoder.anti_caps.options) !==
                        JSON.stringify(guild.moderation.automoder.anti_caps.options)
                ) {
                ...
                if (
                    ...
                    updateData['moderation.automoder.anti_caps.ban_timeout'] =
                        data.moderation.automoder.anti_caps.ban_timeout
                }

                if (
                    typeof data.moderation.automoder.anti_caps.mute_timeout === 'number' &&
                    data.moderation.automoder.anti_caps.mute_timeout !==
                        guild.moderation.automoder.anti_caps.mute_timeout
                ) {
                    updateData['moderation.automoder.anti_caps.mute_timeout'] =
                        data.moderation.automoder.anti_caps.mute_timeout
                }
                ...
                if (data.moderation.automoder.anti_caps.modify_roles) {
                    if (
                        ...
                        updateData['moderation.automoder.anti_caps.modify_roles.add'] =
                            data.moderation.automoder.anti_caps.modify_roles.add
                    }
                    ...
                    if (
                        ...
                        updateData['moderation.automoder.anti_caps.modify_roles.remove'] =
                            data.moderation.automoder.anti_caps.modify_roles.remove
                    }
                }
                ...
                if (data.moderation.automoder.anti_caps.send_message) {
                    if (
                        ...
                        data.moderation.automoder.anti_caps.send_message.content !==
                            guild.moderation.automoder.anti_caps.send_message.content
                    ) {
                        updateData['moderation.automoder.anti_caps.send_message.content'] =
                            data.moderation.automoder.anti_caps.send_message.content
                    }
                    ...
                    if (data.moderation.automoder.anti_caps.send_message.embed) {
                        ...
                        if (JSON.stringify(newEmbed) !== JSON.stringify(oldEmbed)) {
                            updateData['moderation.automoder.anti_caps.send_message.embed'] = {
                                ...
                                description:
                                    typeof newEmbed.description == 'undefined'
                                        ? oldEmbed.description
                                        : newEmbed.description,
                                url: typeof newEmbed.url == 'undefined' ? oldEmbed.url : newEmbed.url,
                                timestamp:
                                    typeof newEmbed.timestamp == 'undefined' ? oldEmbed.timestamp : newEmbed.timestamp,
                                color: typeof newEmbed.color == 'undefined' ? oldEmbed.color : newEmbed.color,
                                footer: {
                                    text:
                                        typeof newEmbed.footer?.text == 'undefined'
                                            ? oldEmbed.footer.text
                                            : newEmbed.footer.text,
                                    icon_url:
                                        typeof newEmbed.footer?.icon_url == 'undefined'
                                            ? oldEmbed.footer.icon_url
                                            : newEmbed.footer.icon_url
                                },
                                image: {
                                    url:
                                        typeof newEmbed.image?.url == 'undefined'
                                            ? oldEmbed.image.url
                                            : newEmbed.image.url
                                },
                                thumbnail: {
                                    url:
                                        typeof newEmbed.thumbnail?.url == 'undefined'
                                            ? oldEmbed.thumbnail.url
                                            : newEmbed.thumbnail.url
                                },
                                author: {
                                    name:
                                        typeof newEmbed.author?.name == 'undefined'
                                            ? oldEmbed.author.name
                                            : newEmbed.author.name,
                                    url:
                                        typeof newEmbed.author?.url == 'undefined'
                                            ? oldEmbed.author.url
                                            : newEmbed.author.url,
                                    icon_url:
                                        typeof newEmbed.author?.icon_url == 'undefined'
                                            ? oldEmbed.author.icon_url
                ...
                if (data.moderation.automoder.anti_caps.ignored) {
                    if (
                        ...
                        updateData['moderation.automoder.anti_caps.ignored.channels'] =
                            data.moderation.automoder.anti_caps.ignored.channels
                    }
                    ...
                    if (
                        ...
                        updateData['moderation.automoder.anti_caps.ignored.roles'] =
                            data.moderation.automoder.anti_caps.ignored.roles
                    }
                    ...
                    if (
                        ...
                        updateData['moderation.automoder.anti_caps.ignored.permissions'] =
                            data.moderation.automoder.anti_caps.ignored.permissions
                    }
                }
            }
            ...
            if (data.moderation.automoder.links_filter) {
                if (
                    ...
                    updateData['moderation.automoder.links_filter.active'] =
                        data.moderation.automoder.links_filter.active
                }
                ...
                if (
                    ...
                    updateData['moderation.automoder.links_filter.allowed_registry'] =
                        data.moderation.automoder.links_filter.allowed_registry
                }
                ...
                if (
                    ...
                    updateData['moderation.automoder.links_filter.blocked_registry'] =
                        data.moderation.automoder.links_filter.blocked_registry
                }

                if (
                    Array.isArray(data.moderation.automoder.links_filter.options) &&
                    JSON.stringify(data.moderation.automoder.links_filter.options) !==
                        JSON.stringify(guild.moderation.automoder.links_filter.options)
                ) {
                    updateData['moderation.automoder.links_filter.options'] =
                        data.moderation.automoder.links_filter.options
                }

                if (
                    typeof data.moderation.automoder.links_filter.ban_timeout === 'number' &&
                    data.moderation.automoder.links_filter.ban_timeout !==
                        guild.moderation.automoder.links_filter.ban_timeout
                ) {
                    updateData['moderation.automoder.links_filter.ban_timeout'] =
                        data.moderation.automoder.links_filter.ban_timeout
                }

                if (
                    typeof data.moderation.automoder.links_filter.mute_timeout === 'number' &&
                    data.moderation.automoder.links_filter.mute_timeout !==
                        guild.moderation.automoder.links_filter.mute_timeout
                ) {
                    updateData['moderation.automoder.links_filter.mute_timeout'] =
                        data.moderation.automoder.links_filter.mute_timeout
                }
                ...
                if (data.moderation.automoder.links_filter.modify_roles) {
                    if (
                        ...
                        updateData['moderation.automoder.links_filter.modify_roles.add'] =
                            data.moderation.automoder.links_filter.modify_roles.add
                    }
                ...
                if (data.moderation.automoder.links_filter.send_message) {
                    if (
                        ...
                        data.moderation.automoder.links_filter.send_message.content !==
                            guild.moderation.automoder.links_filter.send_message.content
                    ) {
                ...
                if (data.moderation.automoder.links_filter.ignored) {
                    if (
                        ...
                        updateData['moderation.automoder.links_filter.ignored.channels'] =
                            data.moderation.automoder.links_filter.ignored.channels
                    }
                    ...
                    if (
                        ...
                        updateData['moderation.automoder.links_filter.ignored.roles'] =
                            data.moderation.automoder.links_filter.ignored.roles
                    }
            ...
            if (data.moderation.automoder.nicknames) {
                ...
                if (
                    ...
                    JSON.stringify(data.moderation.automoder.nicknames.options) !==
                        JSON.stringify(guild.moderation.automoder.nicknames.options)
                ) {
                ...
                if (
                    ...
                    JSON.stringify(data.moderation.automoder.nicknames.contains) !==
                        JSON.stringify(guild.moderation.automoder.nicknames.contains)
                ) {
                ...
                if (data.moderation.automoder.nicknames.ignored) {
                    if (
                        ...
                        updateData['moderation.automoder.nicknames.ignored.roles'] =
                            data.moderation.automoder.nicknames.ignored.roles
                    }
                    ...
                    if (
                        ...
                        updateData['moderation.automoder.nicknames.ignored.permissions'] =
                            data.moderation.automoder.nicknames.ignored.permissions
                    }

                    if (
                        typeof data.moderation.automoder.nicknames.ignored.bots === 'boolean' &&
                        data.moderation.automoder.nicknames.ignored.bots !==
                            guild.moderation.automoder.nicknames.ignored.bots
                    ) {
                        updateData['moderation.automoder.nicknames.ignored.bots'] =
                            data.moderation.automoder.nicknames.ignored.bots
                    }
                }
            }
            ...
            if (data.moderation.automoder.newbies) {
                ...
                if (
                    ...
                    data.moderation.automoder.newbies.minimum_account_age.value !==
                        guild.moderation.automoder.newbies.minimum_account_age.value
                ) {
                    updateData['moderation.automoder.newbies.minimum_account_age.value'] =
                        data.moderation.automoder.newbies.minimum_account_age.value
                }
                ...
                if (
                    ...
                    JSON.stringify(data.moderation.automoder.newbies.options) !==
                        JSON.stringify(guild.moderation.automoder.newbies.options)
                ) {
                ...
                if (
                    ...
                    updateData['moderation.automoder.newbies.ban_timeout'] =
                        data.moderation.automoder.newbies.ban_timeout
                }
                ...
                if (
                    ...
                    updateData['moderation.automoder.newbies.mute_timeout'] =
                        data.moderation.automoder.newbies.mute_timeout
                }
                ...
                if (data.moderation.automoder.newbies.modify_roles) {
                    if (
                        ...
                        updateData['moderation.automoder.newbies.modify_roles.add'] =
                            data.moderation.automoder.newbies.modify_roles.add
                    }
                    ...
                    if (
                        ...
                        updateData['moderation.automoder.newbies.modify_roles.remove'] =
                            data.moderation.automoder.newbies.modify_roles.remove
                    }
                }
            }
            ...
            if (data.moderation.automoder.swear_filter) {
                if (
                    ...
                    updateData['moderation.automoder.swear_filter.active'] =
                        data.moderation.automoder.swear_filter.active
                }
                ...
                if (
                    ...
                    updateData['moderation.automoder.swear_filter.registry'] =
                        data.moderation.automoder.swear_filter.registry
                }

                if (
                    Array.isArray(data.moderation.automoder.swear_filter.options) &&
                    JSON.stringify(data.moderation.automoder.swear_filter.options) !==
                        JSON.stringify(guild.moderation.automoder.swear_filter.options)
                ) {
                    updateData['moderation.automoder.swear_filter.options'] =
                        data.moderation.automoder.swear_filter.options
                }

                if (
                    typeof data.moderation.automoder.swear_filter.ban_timeout === 'number' &&
                    data.moderation.automoder.swear_filter.ban_timeout !==
                        guild.moderation.automoder.swear_filter.ban_timeout
                ) {
                    updateData['moderation.automoder.swear_filter.ban_timeout'] =
                        data.moderation.automoder.swear_filter.ban_timeout
                }

                if (
                    typeof data.moderation.automoder.swear_filter.mute_timeout === 'number' &&
                    data.moderation.automoder.swear_filter.mute_timeout !==
                        guild.moderation.automoder.swear_filter.mute_timeout
                ) {
                    updateData['moderation.automoder.swear_filter.mute_timeout'] =
                        data.moderation.automoder.swear_filter.mute_timeout
                }
                ...
                if (data.moderation.automoder.swear_filter.modify_roles) {
                    if (
                        ...
                        updateData['moderation.automoder.swear_filter.modify_roles.add'] =
                            data.moderation.automoder.swear_filter.modify_roles.add
                    }
                ...
                if (data.moderation.automoder.swear_filter.send_message) {
                    if (
                        ...
                        data.moderation.automoder.swear_filter.send_message.content !==
                            guild.moderation.automoder.swear_filter.send_message.content
                    ) {
                ...
                if (data.moderation.automoder.swear_filter.ignored) {
                    if (
                        ...
                        updateData['moderation.automoder.swear_filter.ignored.channels'] =
                            data.moderation.automoder.swear_filter.ignored.channels
                    }
                    ...
                    if (
                        ...
                        updateData['moderation.automoder.swear_filter.ignored.roles'] =
                            data.moderation.automoder.swear_filter.ignored.roles
                    }
            ...
            if (data.moderation.automoder.users_slowdown) {
                if (
                    ...
                    updateData['moderation.automoder.users_slowdown.active'] =
                        data.moderation.automoder.users_slowdown.active
                }

                if (
                    typeof data.moderation.automoder.users_slowdown.messages_limit === 'number' &&
                    data.moderation.automoder.users_slowdown.messages_limit !==
                        guild.moderation.automoder.users_slowdown.messages_limit
                ) {
                    updateData['moderation.automoder.users_slowdown.messages_limit'] =
                        data.moderation.automoder.users_slowdown.messages_limit
                }
                ...
                if (
                    ...
                    updateData['moderation.automoder.users_slowdown.options'] =
                        data.moderation.automoder.users_slowdown.options
                }

                if (
                    typeof data.moderation.automoder.users_slowdown.ban_timeout === 'number' &&
                    data.moderation.automoder.users_slowdown.ban_timeout !==
                        guild.moderation.automoder.users_slowdown.ban_timeout
                ) {
                    updateData['moderation.automoder.users_slowdown.ban_timeout'] =
                        data.moderation.automoder.users_slowdown.ban_timeout
                }

                if (
                    typeof data.moderation.automoder.users_slowdown.mute_timeout === 'number' &&
                    data.moderation.automoder.users_slowdown.mute_timeout !==
                        guild.moderation.automoder.users_slowdown.mute_timeout
                ) {
                    updateData['moderation.automoder.users_slowdown.mute_timeout'] =
                        data.moderation.automoder.users_slowdown.mute_timeout
                }
                ...
                if (data.moderation.automoder.users_slowdown.modify_roles) {
                    if (
                        ...
                        updateData['moderation.automoder.users_slowdown.modify_roles.add'] =
                            data.moderation.automoder.users_slowdown.modify_roles.add
                    }
                ...
                if (data.moderation.automoder.users_slowdown.ignored) {
                    if (
                        ...
                        updateData['moderation.automoder.users_slowdown.ignored.channels'] =
                            data.moderation.automoder.users_slowdown.ignored.channels
                    }
                    ...
                    if (
                        ...
                        updateData['moderation.automoder.users_slowdown.ignored.roles'] =
                            data.moderation.automoder.users_slowdown.ignored.roles
                    }
        ...
        if (data.moderation.mutes) {
            if (
                typeof data.moderation.mutes.rar === 'boolean' &&
                data.moderation.mutes.rar !== guild.moderation.mutes.rar
            ) {
        ...
        if (data.moderation.ai_mod) {
            if (
                typeof data.moderation.ai_mod.active === 'boolean' &&
                data.moderation.ai_mod.active !== guild.moderation.ai_mod.active
            ) {
                updateData['moderation.ai_mod.active'] = data.moderation.ai_mod.active
            }

            if (
                (typeof data.moderation.ai_mod.log_channel_id === 'string' ||
                    data.moderation.ai_mod.log_channel_id === null) &&
            ...
            if (
                ...
                JSON.stringify(data.moderation.ai_mod.ignored_channels) !==
                    JSON.stringify(guild.moderation.ai_mod.ignored_channels)
            ) {
            ...
            if (
                ...
                JSON.stringify(data.moderation.ai_mod.ignored_roles) !==
                    JSON.stringify(guild.moderation.ai_mod.ignored_roles)
            ) {
    ...
    if (data.modules) {
        if (data.modules.welcome) {
            if (
                typeof data.modules.welcome.active === 'boolean' &&
                data.modules.welcome.active !== guild.modules.welcome.active
            ) {
            ...
            if (
                typeof data.modules.welcome.channel_id === 'string' &&
                data.modules.welcome.channel_id !== guild.modules.welcome.channel_id
            ) {
                ...
                if (data.modules.welcome.message.image) {
                    ...
                    if (JSON.stringify(newImage) !== JSON.stringify(oldImage)) {
                        ...
                        updateData['modules.welcome.message.image'] = {
                            ...
                            background: {
                                color:
                                    typeof newImage.background?.color === 'undefined'
                                        ? oldImage.background?.color
                                        : newImage.background?.color,
                                url:
                                    typeof newImage.background?.url === 'undefined'
                            ...
                            elements: elements.slice(0, 50).map(v => {
                                const element: Record<string, any> = {
                                    ...
                                    height:
                                        typeof v.height === 'number' && v.height <= 9999 && v.height >= -9999
                                            ...
                                            : 50,
                                    width:
                                        typeof v.width === 'number' && v.width <= 9999 && v.width >= -9999
                                            ? v.width
                                            : 50
                                }
                                ...
                                if (v.type === 'IMAGE') {
                                    ...
                                    element['decoration'] = textDecorations.includes(v.decoration)
                                        ? v.decoration
                                        : 'none'
            ...
            if (data.modules.welcome.initial_roles) {
                ...
                if (
                    ...
                    JSON.stringify(data.modules.welcome.initial_roles.roles) !==
                        JSON.stringify(guild.modules.welcome.initial_roles.roles)
                ) {
        ...
        if (data.modules.farewell) {
            if (
                typeof data.modules.farewell.active === 'boolean' &&
                data.modules.farewell.active !== guild.modules.farewell.active
            ) {
            ...
            if (
                typeof data.modules.farewell.channel_id === 'string' &&
                data.modules.farewell.channel_id !== guild.modules.farewell.channel_id
            ) {
        ...
        if (data.modules.levels) {
            if (
                typeof data.modules.levels.active === 'boolean' &&
                data.modules.levels.active !== guild.modules.levels.active
            ) {
                updateData['modules.levels.active'] = data.modules.levels.active
            }

            if (
                typeof data.modules.levels.voice === 'boolean' &&
                data.modules.levels.voice !== guild.modules.levels.voice
            ) {
            ...
            if (data.modules.levels.allowed) {
                if (
                    ...
                    JSON.stringify(data.modules.levels.allowed.channels) !==
                        JSON.stringify(guild.modules.levels.allowed.channels)
                ) {
                ...
                if (
                    ...
                    JSON.stringify(data.modules.levels.allowed.roles) !==
                        JSON.stringify(guild.modules.levels.allowed.roles)
                ) {
            ...
            if (data.modules.levels.blocked) {
                if (
                    ...
                    JSON.stringify(data.modules.levels.blocked.channels) !==
                        JSON.stringify(guild.modules.levels.blocked.channels)
                ) {
                ...
                if (
                    ...
                    JSON.stringify(data.modules.levels.blocked.roles) !==
                        JSON.stringify(guild.modules.levels.blocked.roles)
                ) {
            ...
            if (data.modules.levels.level_up_alerts) {
                ...
                if (
                    ...
                    updateData['modules.levels.level_up_alerts.channel_id'] =
                        data.modules.levels.level_up_alerts.channel_id
                }

                if (data.modules.levels.level_up_alerts.message) {
                    if (
                        typeof data.modules.levels.level_up_alerts.message.content === 'string' &&
                        data.modules.levels.level_up_alerts.message.content !==
                            guild.modules.levels.level_up_alerts.message.content
                    ) {
                        updateData['modules.levels.level_up_alerts.message.content'] =
                            data.modules.levels.level_up_alerts.message.content
                    }
                            ...
                            updateData['modules.levels.level_up_alerts.message.image'] = {
                                ...
                                elements: elements.slice(0, 50).map(v => {
                                    const element: Record<string, any> = {
                                        type: v.type,
                                        posX:
                                            typeof v.posX === 'number' && v.posX <= 9999 && v.posX >= -9999
                                                ? v.posX
                                                : 0,
                                        posY:
                                            typeof v.posY === 'number' && v.posY <= 9999 && v.posY >= -9999
                                                ? v.posY
                                                : 0,
                                        height:
                                            typeof v.height === 'number' && v.height <= 9999 && v.height >= -9999
                                    ...
                                    if (v.type === 'IMAGE') {
                                        ...
                                        element['size'] = Object.keys(textSizes).includes(v.size) ? v.size : 'body2'
                                        element['style'] = textStyles.includes(v.style) ? v.style : 'normal'
                                        element['transform'] = textTransforms.includes(v.transform)
                                            ? v.transform
                                            : 'none'
                                        element['decoration'] = textDecorations.includes(v.decoration)
                                            ? v.decoration
        ...
        if (data.modules.restoring) {
            ...
            if (
                ...
                JSON.stringify(data.modules.restoring.strict_roles) !==
                    JSON.stringify(guild.modules.restoring.strict_roles)
            ) {
        ...
        if (data.modules.music) {
            if (
                ...
                JSON.stringify(data.modules.music.allowed?.channels) !==
                    JSON.stringify(guild.modules.music.allowed?.channels)
            ) {
            ...
            if (
                ...
                JSON.stringify(data.modules.music.blocked?.channels) !==
                    JSON.stringify(guild.modules.music.blocked?.channels)
            ) {
        ...
        if (data.modules.voice_manager) {
            if (
                ...
                JSON.stringify(data.modules.voice_manager.voice_roles) !==
                    JSON.stringify(guild.modules.voice_manager.voice_roles)
            ) {
        ...
        if (data.modules.reports) {
            if (
                typeof data.modules.reports.active === 'boolean' &&
                data.modules.reports.active !== guild.modules.reports.active
            ) {
                updateData['modules.reports.active'] = data.modules.reports.active
            }

            if (
                typeof data.modules.reports.channel_id === 'string' &&
                data.modules.reports.channel_id !== guild.modules.reports.channel_id
            ) {
            ...
            if (
                ...
                updateData['modules.reports.notify_about_unwanted_users'] =
                    data.modules.reports.notify_about_unwanted_users
            }
        }

        if (
            Array.isArray(data.modules.autothreads) &&
            JSON.stringify(data.modules.autothreads) !== JSON.stringify(guild.modules.autothreads)
        ) {
        ...
        if (data.modules.economy) {
            if (
                typeof data.modules.economy.active == 'boolean' &&
                data.modules.economy.active !== guild.modules.economy.active
            ) {
            ...
            if (data.modules.economy.transfer) {
                if (
                    ...
                    JSON.stringify(data.modules.economy.transfer.allowed_roles) !==
                        JSON.stringify(guild.modules.economy.transfer.allowed_roles)
                ) {
                ...
                if (
                    ...
                    JSON.stringify(data.modules.economy.transfer.blocked_roles) !==
                        JSON.stringify(guild.modules.economy.transfer.blocked_roles)
                ) {
        ...
        if (data.modules.activities) {
            if (
                ...
                JSON.stringify(data.modules.activities.multipliers) !==
                    JSON.stringify(guild.modules.activities.multipliers)
            ) {
        ...
        if (data.modules.guild_image_rotation) {
            if (data.modules.guild_image_rotation.banner) {
                if (
                    ...
                    updateData['modules.guild_image_rotation.banner.active'] =
                        data.modules.guild_image_rotation.banner.active
                }
    ...
    if (data.web_page) {
        if (
            typeof data.web_page.public_leaderboard === 'boolean' &&
            data.web_page.public_leaderboard !== guild.web_page.public_leaderboard
        ) {
    ...
    return await database.servers.findOne({ _id: guild._id }).orFail()
}
