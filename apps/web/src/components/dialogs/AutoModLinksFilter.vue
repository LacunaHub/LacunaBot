            ...
            <q-card-section>
              <div class="row q-col-gutter-md">
                <div class="col-12">
                  ...
                  <q-select
                    v-model="config.blocked_registry"
                ...
                <div class="col-12">
                  ...
                  <q-select
                    v-model="config.allowed_registry"
                    :disable="!config.active"
                    class="q-pt-sm"
                    filled
                    dense
                  ...
                  >
                    <template #selected-item="{ opt }">
                      <q-chip
                        ...
                        size="sm"
                        removable
                        @remove="config.allowed_registry.splice(config.allowed_registry.indexOf(opt), 1)"
                      ></q-chip>
                    </template>
                  </q-select>
                </div>
                    ...
                    <div class="row q-col-gutter-md">
                      <div class="col-12">
                        ...
                        <q-select
                          ...
                          :options="[
                            60, 120, 300, 600, 900, 1800, 3600, 7200, 21600, 43200, 64800, 86400, 172800, 259200,
                            604800, 1209600
                          ]"
                          :disable="!config.active"
                          class="q-pt-sm"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const config = ref(JSON.parse(JSON.stringify(guild.moderation.automoder.links_filter)))
