      ...
      <q-card-section>
        <div class="row q-col-gutter-md">
          <div class="col-12">
            ...
            <q-select
              v-model="command.config.permissions.allowed_channels"
          ...
          <div class="col-12">
            ...
            <q-select
              v-model="command.config.permissions.blocked_channels"
              :options="guild.channelsText"
              option-label="name"
              option-value="id"
              :disable="command.config.inactive"
      ...
      <q-card-section>
        <div class="row q-col-gutter-md">
          <div class="col-12">
            ...
            <q-select
              v-model="command.config.permissions.allowed_roles"
              :options="guild.roles"
              option-label="name"
              option-value="id"
              :disable="command.config.inactive"
          ...
          <div class="col-12">
            ...
            <q-select
              v-model="command.config.permissions.blocked_roles"
              :options="guild.roles"
              option-label="name"
              option-value="id"
              :disable="command.config.inactive"
