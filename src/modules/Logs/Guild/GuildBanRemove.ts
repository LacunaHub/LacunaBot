            ...
            if (!webhook) {
                ...
                try {
                    webhook = await log.createWebhook(`${self.user.username}`, {
                        ...
                        reason: self.translator.format(locale.modules.logs.common.webhook_create_reason, locale.commands.common.case_log.cases.BAN_REMOVE)
                    })
                } catch (err) {
                    return false
                }
            ...
            const embed = new MessageEmbed()
                ...
                .setDescription(
                    self.translator.format(
                        locale.modules.logs.guild_ban_remove.template,
