...
import { TwitchIncomingWebhook, eventSubSubscribe, eventSubUnsubscribe, getEventSubsByUserId } from '../../../modules/social-alerts/TwitchAlerts'
import APIError from '../../../utility/APIError'
import DiscordUtils from '../../../utility/DiscordUtils'

export default async function updateTwitchSocialAlert(ctx: Context) {
    ...
    try {
        switch (method) {
            case 'create':
                response = await createTwitchSocialAlert(server, data)
                break

            case 'update':
                response = await setTwitchSocialAlert(server, data)
                break

            case 'delete':
                response = await deleteTwitchSocialAlert(server, data)
                break
...
export async function createTwitchSocialAlert(server: ServerDocument, data: any) {
...
export async function setTwitchSocialAlert(server: ServerDocument, data: any) {
...
export async function deleteTwitchSocialAlert(server: ServerDocument, data: any) {
    ...
    const subscribedGuilds = await database.servers.find({
        'modules.subscriptions.twitch.broadcaster_id': subscription.broadcaster_id
    })
