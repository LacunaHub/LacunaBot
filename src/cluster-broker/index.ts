...
clusterBroker.on('managerHeartbeat', (manager, beatsGap) => logger.info({ id: manager.id, beatsGap }, 'manager heartbeat'))
clusterBroker.on('managerShardsAssign', (manager, shards) => logger.info({ id: manager.id, shards }, 'manager shard assignment'))
